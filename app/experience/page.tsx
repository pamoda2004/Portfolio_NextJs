          ...
          <div className="space-y-4 md:space-y-0 md:divide-y md:divide-white/10">
            {experiences.map((item, index) => (
              <Reveal key={item.company} delay={index * 0.08}>
                <div className="group relative overflow-hidden rounded-[1.35rem] border border-white/10 bg-white/[0.045] p-5 shadow-[0_18px_50px_rgba(0,0,0,0.18)] backdrop-blur-sm transition duration-300 hover:border-white/20 hover:bg-white/[0.07] md:grid md:grid-cols-3 md:items-center md:gap-4 md:rounded-none md:border-0 md:bg-transparent md:p-0 md:py-8 md:shadow-none md:hover:bg-transparent">
                  ...
                  <h2 className="text-[clamp(1.35rem,6vw,2rem)] font-black leading-tight tracking-[-0.035em] text-[#f4f4f1] transition-transform duration-300 group-hover:translate-x-1 md:text-3xl md:tracking-[-0.04em]">
                    {item.company}
                  </h2>

                  <p className="mt-2 text-sm font-medium leading-6 text-white/55 transition-colors group-hover:text-white/85 md:mt-0 md:text-base">
                    {item.role}
                  </p>
                </div>
              </Reveal>
